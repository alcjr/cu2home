    ...
    const gridInstanceRef = $('#alertsGrid').dxDataGrid({
        ...
        editing: {
            ...
            popup: {
                ...
                showTitle: true,
                // Un poco más ancho que antes (720 -> 800): con la
                // pestaña "Filtros de búsqueda" ahora a 2 columnas, cada
                // card necesita más aire horizontal para no apretar los
                // selects/números de precio.
                width: function () { return Math.min(window.innerWidth * 0.96, 800); },
                ...
                // pestaña.
                height: function () { return Math.min(window.innerHeight * 0.86, 640); },
                ...
                items: [
                    {
                        ...
                        tabs: [
                            ...
                            },
                            {
                                ...
                                // 2 columnas para que las 5 cards se
                                // repartan en 3 filas (Tipo de inmueble +
                                // Ubicación / Venta + Alquiler /
                                // Comodidades a ancho completo) en vez de
                                // apilarse en una sola columna -- así el
                                // contenido de la pestaña cabe sin scroll
                                // vertical dentro de la altura fija del
                                // popup.
                                colCount: 2,
                                items: [
                                    {
